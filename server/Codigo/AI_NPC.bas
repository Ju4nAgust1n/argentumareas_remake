    ...
    With Npclist(NpcIndex)
        ...
        If .flags.Inmovilizado = 1 Then
            ...
            For i = 1 To MAX_ADY
                ...
                For Each UserIndex In areasData(.Pos.map, adyacentArea(.newAreas.areaID).ady(i)).userArea.Items
...
Public Sub AiNpcObjeto(ByVal NpcIndex As Integer)
    ...
    With Npclist(NpcIndex)
        ...
        For i = 1 To MAX_ADY
            ...
            For Each UI In areasData(.Pos.map, adyacentArea(.newAreas.areaID).ady(i)).userArea.Items
