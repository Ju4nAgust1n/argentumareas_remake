...
UserList(UserIndex).ConnIDValida = False
UserList(UserIndex).ConnID = -1
UserList(UserIndex).newAreaXID = -1
UserList(UserIndex).newAreaYID = -1
...
Call removeUserArea(UserIndex, UserList(UserIndex).Pos.map, UserList(UserIndex).Pos.X, UserList(UserIndex).Pos.Y)
